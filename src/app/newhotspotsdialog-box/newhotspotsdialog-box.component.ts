...
@Component({
  selector: 'app-newhotspotsdialog-box',
  templateUrl: './newhotspotsdialog-box.component.html',
  styleUrls: ['./newhotspotsdialog-box.component.scss'],
})

export class NewhotspotsdialogBoxComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<NewhotspotsdialogBoxComponent>,
  ...
  selectStartpakket(checkValue) {
    console.log(this.catalogueProperty);

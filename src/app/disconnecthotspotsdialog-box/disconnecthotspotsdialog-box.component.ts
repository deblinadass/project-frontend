...
@Component({
  selector: 'app-disconnecthotspotsdialog-box',
  templateUrl: './disconnecthotspotsdialog-box.component.html',
  styleUrls: ['./disconnecthotspotsdialog-box.component.scss'],
})

export class DisconnecthotspotsdialogBoxComponent {
  ConType;
  ...
  BOUWOrderTerminationReasonList: any[];
  hasnextstateid;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DisconnecthotspotsdialogBoxComponent>,
  ...
  ngOnInit() {
    ...
    if (this.local_data.action == 'Add') {
      ...
      this.hotspotscreateform = this.formBuilder.group({
        ...
        BOUWOrderTerminationReason: ['', Validators.required],
        /****** New Attr ******/
      ...
      this.hotspotscreateform = this.formBuilder.group({
        ...
        BOUWOrderContactid: [this.local_data.BOUWOrderContactid, Validators.required],
        ...
        BOUWOrderContractor: [this.local_data.BOUWOrderContractor, Validators.required],
        ...
        BOUWSOrderContractor: [this.local_data.BOUWSOrderContractor],
        BOUWSOrderWishdate: [this.local_data.BOUWSOrderWishdateEdit],
        BOUWOrderCoverage: [''],
        BOUWOrderSelectedType: [''],
        BOUWOrderTerminationReason: [this.local_data.BOUWOrderTerminationReason, Validators.required],
        /****** New Attr ******/
  ...
  onUpdate(form: NgForm) {
    ...
    this.orderFormUpdatedValue.push({
      ...
      BOUWOrderTerminationReason: this.hotspotscreateform.get('BOUWOrderTerminationReason').value,
  ...
  populateformdropdown() {
    ...
    this._orderservice.getOrderProperty('BOUWOrderTerminationReason').subscribe(data => {
      this.BOUWOrderTerminationReasonList = data;
    }, error => this.toasterservice.showError(error));

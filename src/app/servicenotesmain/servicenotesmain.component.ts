...
@Component({
  selector: 'app-servicenotesmain',
  templateUrl: './servicenotesmain.component.html',
  styleUrls: ['./servicenotesmain.component.scss']
})
export class ServicenotesmainComponent implements OnInit {
